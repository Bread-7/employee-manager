...
var qrcode = (function () {
  var t = function (t, r) {
    var e = t,
      ...
      s = function () {
        for (var t = p.getPatternPosition(e), r = 0; r < t.length; r += 1)
      ...
      d = function (t, r) {
        for (
          var e = (n << 3) | r, a = p.getBCHTypeInfo(e), u = 0;
          u < 15;
          u += 1
        ) {
          var f = !t && 1 == ((a >> u) & 1);
      ...
      y = function (t, r, e) {
        for (
          var n = C.getRSBlocks(t, r), o = k(), i = 0;
          i < e.length;
          i += 1
        ) {
          var a = e[i];
          o.put(a.getMode(), 4),
            o.put(a.getLength(), p.getLengthInBits(a.getMode(), t)),
            a.write(o);
        }
        var u = 0;
        ...
        return (function (t, r) {
          for (
            ...
            e += f;
            var l = p.getErrorCorrectPolynomial(c),
              h = B(i[u], l.getLength() - 1).mod(l);
            for (
    ...
    (c.addData = function (t, r) {
      ...
      (c.make = function () {
        if (e < 1) {
          for (var t = 1; t < 40; t++) {
            for (
              var r = C.getRSBlocks(t, n), o = k(), i = 0;
              i < u.length;
              i++
            ) {
              var a = u[i];
      ...
      (c.createSvgTag = function (t, r, e, n) {
        ...
        for (
          f = "l" + t + ",0 0," + t + " -" + t + ",0 0,-" + t + "z ",
            ...
            l += ">",
            l += n.text
              ? '<title id="' + m(n.id) + '">' + m(n.text) + "</title>"
              : "",
            l += e.text
              ? '<description id="' +
                m(e.id) +
      ...
      (c.createImgTag = function (t, r, e) {
        (t = t || 2), (r = void 0 === r ? 4 * t : r);
        var n = c.getModuleCount() * t + 2 * r,
          o = "";
        return (
          (o += "<img"),
          (o += ' src="'),
          (o += c.createDataURL(t, r)),
          (o += '"'),
          (o += ' width="'),
          (o += n),
          (o += '"'),
  ...
  var r,
    ...
    p =
      ...
      ((e = {}).getBCHTypeInfo = function (t) {
        for (var r = t << 10; n(r) - n(1335) >= 0; )
          r ^= 1335 << (n(r) - n(1335));
        return 21522 ^ ((t << 10) | r);
      }),
      (e.getBCHTypeNumber = function (t) {
        for (var r = t << 12; n(r) - n(7973) >= 0; )
          r ^= 7973 << (n(r) - n(7973));
        return (t << 12) | r;
      }),
        ...
        multiply: function (t) {
          for (
            ...
            for (var o = 0; o < t.getLength(); o += 1)
              r[e + o] ^= y.gexp(y.glog(n.getAt(e)) + y.glog(t.getAt(o)));
          return B(r, 0);
        },
        mod: function (t) {
          if (n.getLength() - t.getLength() < 0) return n;
          for (
            var r = y.glog(n.getAt(0)) - y.glog(t.getAt(0)),
      ...
      return (
        (e.getRSBlocks = function (e, n) {
          ...
          for (var i = o.length / 3, a = [], u = 0; u < i; u += 1)
            for (
              var c = o[3 * u + 0], g = o[3 * u + 1], l = o[3 * u + 2], h = 0;
              h < c;
              h += 1
            )
              a.push(r(g, l));
        ...
        n = {
          ...
          write: function (t) {
            for (var r = e, n = 0; n + 2 < r.length; )
              t.put(i(r.substring(n, n + 3)), 10), (n += 3);
            n < r.length &&
              (r.length - n == 1
                ? t.put(i(r.substring(n, n + 1)), 4)
                : r.length - n == 2 && t.put(i(r.substring(n, n + 2)), 7));
          },
        },
        i = function (t) {
        ...
        var u,
          ...
          v =
            ...
            ((l = {}).writeByte = function (t) {
              for (u = (u << 8) | (255 & t), f += 8, c += 1; f >= 6; )
                h(u >>> (f - 6)), (f -= 6);
            }),
            (l.flush = function () {
              if ((f > 0 && (h(u << (6 - f)), (u = 0), (f = 0)), c % 3 != 0))
                for (var t = 3 - (c % 3), r = 0; r < t; r += 1) g += "=";
            }),
            (l.toString = function () {
              return g;
            }),
